...
const moviesRoutes_1 = __importDefault(require("../routes/v1/moviesRoutes")); // <-- your TS route file
...
describe("IMDB Movies API Test Suite", () => {
    ...
    it("TEST 1 : Should return health check", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/health");
    ...
    it("TEST 2 : Should return movies for a valid year", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/year/2020?page=1");
        expect(res.statusCode).toBe(200);
    ...
    it("TEST 3 : Should return 400 for invalid year", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/year/abcd");
    ...
    it("TEST 4 : Should return 404 for year with no movies", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/year/1800");
    ...
    it("TEST 5 : Should return movies for a valid genre", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/genre/Action");
        expect(res.statusCode).toBe(200);
        expect(res.body).toHaveProperty("results");
        expect(res.body.results).toBeInstanceOf(Array);
        expect(res.body.results.length).toBeGreaterThan(0);
    ...
    it("TEST 6 : Should return 404 for genre with no movies", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/genre/UnknownGenre");
        expect(res.statusCode).toBe(404);
    ...
    it("TEST 7 : Should return paginated movies", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies?page=1");
        expect(res.statusCode).toBe(200);
        expect(res.body).toHaveProperty("results");
        expect(res.body.results).toBeInstanceOf(Array);
        expect(res.body.results.length).toBeGreaterThan(0);
    ...
    it("TEST 8 : Should return 404 for page with no movies", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies?page=9999");
        expect(res.statusCode).toBe(404);
    ...
    it("TEST 9 : Should return movie details for a valid imdbId", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/tt0111161"); // Shawshank Redemption
        expect(res.statusCode).toBe(200);
        expect(res.body).toHaveProperty("title", "The Shawshank Redemption");
        expect(res.body).toHaveProperty("imdbId", "tt0111161");
        expect(res.body).toHaveProperty("averageRating");
    });
    it("TEST 10 : Should return 404 for invalid imdbId", async () => {
        const res = await (0, supertest_1.default)(app).get("/api/v1/movies/invalidImdbId");
        expect(res.statusCode).toBe(404);
